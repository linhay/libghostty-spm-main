...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty-spm-main/releases/download/storage.1.0.1775462803/GhosttyKit.xcframework.zip",
            checksum: "725656fd55821d4d45a77c5110382d2c7004073789044069fe4b1d3ea8c50856"
        ),
        .testTarget(
            name: "GhosttyKitTest",

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty-spm-main/releases/download/storage.1.0.1784540322/GhosttyKit.xcframework.zip",
            checksum: "72cd6ff72b255d8c3c0168d9690861512ceba871ee08d466ae12ea4e62d59d55"
        ),
        .testTarget(
            name: "GhosttyKitTest",

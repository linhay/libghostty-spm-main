...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty-spm-main/releases/download/storage.1.0.1783936238/GhosttyKit.xcframework.zip",
            checksum: "2e9ec372b3bcdfc53b85d58df2c57f8d3843b72d6e1450d5bf9d85fcc2217d99"
        ),
        .testTarget(
            name: "GhosttyKitTest",

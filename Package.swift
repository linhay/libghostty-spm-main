...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty-spm-main/releases/download/storage.1.0.1780917765/GhosttyKit.xcframework.zip",
            checksum: "1c285cc81b3f479e6c3f5347dcc1029dd2ade2aeaeee9112b94d2bbb47ad2add"
        ),
        .testTarget(
            name: "GhosttyKitTest",

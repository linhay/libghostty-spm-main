...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/linhay/libghostty-spm-main/releases/download/storage.1.0.1776673826/GhosttyKit.xcframework.zip",
            checksum: "f193cc3d799d73798f6578467b72f0f2521c583b8ba8a2da4a60917e54dd2369"
        ),
        .testTarget(
            name: "GhosttyKitTest",
